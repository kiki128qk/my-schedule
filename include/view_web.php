<div class="categoryTabs">
                <a href="/my-schedule/pages/sch_view.php?key=view_all">All</a>
                ...
                <a href="/my-schedule/pages/sch_view.php?key=view_web" class="active">WEB Planning</a>
            </div>
          <ul class="boardTable">
            <li class="boardTitle">
            ...
            <li class="boardList">
              ...
              <span class="boTit"><a class=boTitA href=""><?=$bo_tit?></a></span>
